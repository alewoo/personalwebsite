import { c as createComponent, r as renderTemplate, a as renderSlot, b as addAttribute, d as renderHead, e as createAstro } from './astro/server_B6IEuQq7.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                         */
    ...
    items: [
      {
        ...
        description: "conducting research at the intersection of AI and human-computer interaction to build more intuitive and user-centric AI systems."
      },
      // {
      ...
      // },
      {
        ...
        description: "leading georgia tech's premier startup organization to foster innovation across campus."
      }
      // {
  ...
  projects: [
    {
      ...
      description: "reimagining college dating through personality analytics. built and launched in 3 days, reaching 250+ users and 40+ signups in its first week at georgia tech.",
      image: "/datematch.png",
      year: "feb 2025",
...
const $$Layout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate(_a || (_a = __template([' <html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/png" href="/alex.png"><meta name="generator"', "><title>", '</title><meta name="description"', '><meta property="og:title"', '><meta property="og:description"', '><meta property="og:image"', '><script src="https://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js"><\/script>', '</head> <body> <header> <div class="px-6 py-6 max-w-2xl mx-auto"> <nav> <ul class="hidden sm:flex sm:items-center sm:gap-2"> ', ' </ul> <div class="relative sm:hidden"> <button id="link-menu-button" class="relative font-medium opacity-60 p-4">\nMenu <span id="open-indicator">+</span> </button> <div id="link-menu" class="absolute p-2 left-0 bg-gray-bg rounded-lg w-44 transition-opacity ease-in-out duration-300 opacity-0 z-40"> <ul> ', ' </ul> </div> </div> </nav> </div> </header> <main class="mb-32"> ', ' </main> <footer></footer> <div id="particles-js" class="fixed inset-0 -z-10"></div> <div class="fixed inset-0 -z-20"> <div class="absolute top-32 left-12 w-24 h-24 bg-blue-500/10 rounded-full blur-2xl"></div> <div class="absolute bottom-32 right-12 w-32 h-32 bg-blue-500/10 rounded-full blur-2xl"></div> <div class="absolute top-1/2 right-1/4 w-28 h-28 bg-blue-500/10 rounded-full blur-3xl"></div> <div class="absolute bottom-1/4 left-1/3 w-36 h-36 bg-blue-500/10 rounded-full blur-3xl"></div> </div>  </body></html>'])), addAttribute(Astro2.generator, "content"), seo.title, addAttribute(seo.description, "content"), addAttribute(seo.title, "content"), addAttribute(seo.description, "content"), addAttribute(seo.image, "content"), renderHead(), navBarLinks.map((link) => renderTemplate`<li> <a class="group px-4 py-2 rounded-lg hover:bg-gray-bg opacity-60 hover:opacity-100 transition-all"${addAttribute(link.url, "href")}${addAttribute(link.external ? "_blank" : "_self", "target")}> ${link.title} </a> </li>`), navBarLinks.map((link) => renderTemplate`<li> <a class="block pl-4 py-3"${addAttribute(link.url, "href")}${addAttribute(link.external ? "_blank" : "_self", "target")}> ${link.title} </a> </li>`), renderSlot($$result, $$slots["default"]));
}, "/Users/alexwang/Code/WebDev/astro-minimal-portfolio-template/src/layouts/Layout.astro", void 0);

export { $$Layout as $, aboutPageContent as a, homePageContent as h, identity as i, projectsPageContent as p };
